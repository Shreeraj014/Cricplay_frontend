...
const MatchMicroBets = ({ match, handleOddsClick }) => {
    ...
    return (
        <div className="mt-4 rounded-xl border border-gray-800 bg-[#121417] p-1.5 text-gray-900 shadow-xl sm:p-3">
            <div className="w-full h-auto flex flex-col gap-4 lg:gap-6 pb-8 lg:pb-12">
                {/* Header Banner */}
                ...
                <>
                    ...
                    <div className="space-y-4">
                        {matches?.map((match, index) => {
                            ...
                            return (
                                <div key={match.id} className="relative overflow-hidden rounded-xl border border-gray-800 bg-[#121417] p-3 shadow-lg sm:p-5">
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mt-6 pb-safe">
                                        <div id={index === 0 ? 'match-winner' : undefined} className="col-span-1 space-y-4">
                                            <div className="rounded-xl border border-gray-800 bg-[#0f1115] p-3 sm:p-5">
                                        ...
                                        <div id={index === 0 ? 'micro-bets' : undefined} className="col-span-1 w-full h-auto">
                                            <MatchMicroBets match={match} handleOddsClick={handleOddsClick} />
                                        </div>

                                        <div id={index === 0 ? 'over-sessions' : undefined} className="col-span-1 scroll-mt-24">
                                            <div className="rounded-xl border border-gray-800 bg-[#0f1115] p-3 sm:p-5">
